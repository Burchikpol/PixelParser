  ...
  methods: {
    ...
    fetchSites: function fetchSites() {
      ...
      this.sites.forEach(function (site) {
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('curl.php?link=' + site['url']).then(function (res) {
          _this2.checked.push(res.data);
        });
        _this2.currentSite += 1;
  ...
  return _c("div", [
    _c(
      ...
      _vm._l(_vm.checked, function(site) {
        return _c("li", [
          _vm._v(_vm._s(site.url) + " responded with " + _vm._s(site.status))
        ])
      }),
      0
    )
...
module.exports = __webpack_require__(/*! /Users/andriiishchenko/Sites/gdocs/src/app.js */"./src/app.js");
